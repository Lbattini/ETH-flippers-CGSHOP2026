...
For further information, see the paper on arxiv (to be released).
See the XOR-SAT folder for the XOR-SAT formulation, and how to use it. The two\_triangulations folder contains an implementation of the paper "Simultaneous edge flipping in triangulations" (J Galtier, F Hurtado, M Noy, S Pérennes, J Urrutia, 2003), which was not used in the competition because the resulting solutions are not good.
